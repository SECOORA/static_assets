...
<qgis version="2.14.3-Essen" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="Abrreviated ID">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="MHz">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="Status">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="StartAngle">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="SpreadAngle">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="Status" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="Construction" label="Construction"/>
      <category render="true" symbol="1" value="Operational" label="Operational"/>
      <category render="true" symbol="2" value="Permitting" label="Permitting"/>
      <category render="true" symbol="3" value="Planned" label="Proposed"/>
    </categories>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="DisplayTitle ||' (' || MHz || 'mhz)'"/>
  ...
  <displayfield>Abrreviated ID</displayfield>
  <label>0</label>
  <labelattributes>
