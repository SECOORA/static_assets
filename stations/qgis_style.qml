...
<qgis version="2.14.3-Essen" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="DisplayTitle">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="PlatformType">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 attr="&quot;Status&quot; || '_' ||  &quot;PlatformType&quot; " forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="Planned_Fixed Coastal Station" label="Proposed"/>
      <category render="true" symbol="1" value="Planned_Fixed Bottom Mount Mooring" label="Proposed"/>
      <category render="true" symbol="2" value="Operational_Fixed Surface Buoy" label="Operational"/>
      <category render="true" symbol="3" value="Operational_Fixed Coastal Station" label="Operational"/>
      <category render="true" symbol="4" value="Operational_Fixed Bottom Station" label="Operational"/>
      <category render="true" symbol="5" value="Operational_Fixed Bottom Mount Mooring" label="Operational"/>
      <category render="true" symbol="6" value="Decommissioned_Fixed Bottom Station" label="Decommissioned"/>
      <category render="true" symbol="7" value="Construction_Fixed Coastal Station" label="Construction"/>
    </categories>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="217,137,51,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/dist" value="0.05"/>
    <property key="labeling/distInMapUnits" value="false"/>
    <property key="labeling/distMapUnitScale" value="0,0,0,0,0,0"/>
    <property key="labeling/drawLabels" value="true"/>
    <property key="labeling/enabled" value="true"/>
    <property key="labeling/fieldName" value="DisplayTitle"/>
